...
# Store the default WebCam for later use
    ...
    if process_this_frame:
        ...
        if len(face_encodings) == 0:
            ...
            if name != previous_name:
                print("No person in the camera's viewport")
                previous_name = "No person"
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                name = known_face_names[best_match_index]  # Px: Kwstas

                if name != previous_name:
                    print("The Person in front of the Camera is: " + name)
                    previous_name = name

            if not matches[best_match_index]:
                name = "Unknown"
                if name != previous_name:
                    print("The Person in front of the Camera is Not on the Database! ")
                    previous_name = name
